...
function WhileNode(expr, bodynode) {
    this.expression = function () { return expr; };
    this.bodyNode = function () { return bodynode; };
}

function createWhileNode(expr, bodynode) {
    return new WhileNode(expr, bodynode);
}

...
// functions
pdef.define('function', [ '?visibility', 'type', 'name:', 'delimiter:(', 'delimiter:)', 'command' ], function (values) { return geast.function(values[2], values[1], [], values[5], values[0] || visibilities.private); });

...
// functions
pdef.define('function', [ '?visibility', 'xtype', 'name:', 'delimiter:(', 'argumentlist', 'delimiter:)', 'command' ], function (values) { return geast.function(values[2], values[1], values[4], values[6], values[0] || visibilities.private); });

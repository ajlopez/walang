...
// functions
pdef.define('function', [ '?visibility', 'type', 'name:', 'delimiter:(', 'argumentlist', 'delimiter:)', 'command' ], function (values) { return geast.function(values[2], values[1], values[4], values[6], values[0] || visibilities.private); });
...
pdef.define('argument', [ 'type', 'name:' ], function (values) { return geast.argument(values[1], values[2]); });
...
pdef.define('return', [ 'name:return', 'expression' ], function (values) { return geast.return(values[1]); });
...
pdef.define('type', 'name:void', function (value) { return types.void; });
